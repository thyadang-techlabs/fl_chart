...
class RadarChartData extends BaseChartData with EquatableMixin {
  ...
  final Color radialGraphPaintColor2;
  ...
  RadarChartData copyWith({
    ...
    FlBorderData? borderData,
      ...
      RadarChartData(
        ...
        radialGraphPaintColor2:
            radialGraphPaintColor2 ?? this.radialGraphPaintColor,
  ...
  RadarChartData lerp(BaseChartData a, BaseChartData b, double t) {
    if (a is RadarChartData && b is RadarChartData) {
      return RadarChartData(
        ...
        radialGraphPaintColor2:
            Color.lerp(a.radialGraphPaintColor2, b.radialGraphPaintColor2, t),
        getTitle: b.getTitle,
